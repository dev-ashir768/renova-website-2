...
CREATE DATABASE IF NOT EXISTS renova_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE renova_db;

CREATE TABLE IF NOT EXISTS portfolio_items (
  id          INT AUTO_INCREMENT PRIMARY KEY,
  title       VARCHAR(255)    NOT NULL,
  category    VARCHAR(50)     NOT NULL,  -- website, branding, mobile, webapp, ecommerce, marketing
  description TEXT,
  image       VARCHAR(500)    DEFAULT NULL,  -- uploaded image filename
  client      VARCHAR(255)    DEFAULT NULL,
  year        YEAR            DEFAULT NULL,
  tags        VARCHAR(500)    DEFAULT NULL,  -- comma-separated tags
