...
(function () {
  ...
  const isPortfolio = path === 'portfolio.html';
  ...
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
      <div class="md:col-span-2">
        ...
        <a href="tel:+13435128311" class="inline-flex items-center gap-2 mt-4 text-sm text-gold hover:text-gold-dark transition-colors font-medium">
